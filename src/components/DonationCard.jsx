...
const DonationCard = ({card:{img, title, content}, index}) => {
  return (
    <div className='flex flex-col gap-y-2 p-3 w-50 justify-center items-center border-color-light hover:border-color-green border-4 rounded-2xl cursor-pointer'>
